...
function NavigationMenuMobile({ toggleMenu }) {
  return (
    <div className="absolute overflow-x-hidden top-0 h-screen w-80 right-0 z-50 animate-slideIn">
      <div className="flex flex-col right-0 w-80 h-screen absolute bg-white translate-x-0 overflow-y-scroll scroll-smooth">
        {/* Close button */}
